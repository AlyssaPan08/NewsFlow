...
import com.laioffer.tinnews.ui.NewsViewModelFactory;
...
public class HomeFragment extends Fragment implements CardStackListener {
    ...
    private FragmentHomeBinding binding; //根据xml文件名来
    ...
    //当view创建完成，add business logic here
    //viewModel要通过viewModelProvider来new
    @Override
    ...
    public void onCardSwiped(Direction direction) {
        if (direction == Direction.Left) {
            ...
            Article article = articles.get(layoutManager.getTopPosition() -1); //get(index)
