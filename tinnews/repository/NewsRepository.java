...
public class NewsRepository {
    ...
    //database I/O & networking 都慢于其他操作 -> background thread
    //UI -> main thread
    private static class FavoriteAsyncTask extends AsyncTask<Article, Void, Boolean> {
        ...
        @Override
        protected Boolean doInBackground(Article... articles) { //do task in background thread
        ...
        @Override
        protected void onPostExecute(Boolean success) { //task done, use callback to pass result
